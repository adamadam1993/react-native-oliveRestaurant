...
import { Pressable, Text, Image, View, TextInput, ScrollView, Modal } from 'react-native'
...
function Checkout(props) {
    ...
    const prev_btnAction = () => {
        ...
        } else if(displayStt === -1){
            props.chkaction(false);
            props.navigation.navigate('Main')
        } 
    }

    return (
        <Modal animationType="fade" transparent={true} visible={props.chkvisible} onRequestClose={() => {
            props.chkaction(props.chkvisible);
            }}>
            <View>
                {
                    displayStt === 0 ? (
                        <ScrollView>
                            <View className="w-full h-full bg-[#000000b8] items-center">
                                    ...
                                    <View className="w-[829px] rounded-[10px] mt-[49px] mb-[98px] bg-white">
                                        <View className="pl-[51px] pr-[45px] pt-[49px] pb-[31px]">
                                            ...
                                            <View className="pb-[20px]">
                                                <TextInput className="w-[729px] rounded-[10px] pl-[20px] bg-[#f5f5f5] h-[50px]" placeholder='Full Name'></TextInput>
                                            </View>
                    ...
                    <ScrollView>
                        <View className={props.className + " w-full h-full bg-[#000000b8]" + " items-center"}>
                            <Pressable className="absolute top-[77px] left-[71px]" onPress={() => prev_btnAction()}>
                                <Image source={prev_btn}></Image>
                            </Pressable>
                            <View>
